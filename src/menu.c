...
void load_text(SDL_Renderer *renderer, SDL_Font *menu_items, int screen_width) {
...
void render_text(SDL_Renderer *renderer, SDL_Font *menu_items, int start_y,
                 int gapy) {
  int y = start_y;
...
void menu_item_up(SDL_Renderer *renderer, SDL_Font *menu_items,
                  int screen_width) {
...
void menu_item_down(SDL_Renderer *renderer, SDL_Font *menu_items,
                    int screen_width) {
